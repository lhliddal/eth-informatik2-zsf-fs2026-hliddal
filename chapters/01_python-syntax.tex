\section{Python-Syntax \& Container}\label{sec:01-python-syntax-uebersicht}
...
% -----------------------------
\subsection{Container-Operationen (allgemein)}\label{sec:01-operationen-auf-containern}
\begin{contentbox}
...
% -----------------------------
\subsection{Geordnete Container: list / tuple / str}\label{sec:01-sequenzen-geordnete-container}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
% -----------------------------
\subsection{Ungeordnete Container: set / dict}\label{sec:01-collections-ungeordnete-container}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
# set: keine Duplikate
s = {1, 2, 3}
