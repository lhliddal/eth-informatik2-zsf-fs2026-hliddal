...
\tcbset{zsf@codebox@split@base/.style={
  ...
  colback=white,
  colframe=\ZSFBaseBoxBorderColor,
  leftrule=\ZSFborderThin, rightrule=\ZSFborderThin,
...
% 5. Inline-Formelbox
% ============================================================
\newcommand{\eqbox}[1]{\fcolorbox{\ZSFTitledBoxBorderColor}{\chaptercolorlight}{\(\displaystyle #1\)}}
...
% Kanonischer Template-Name fuer dieselbe Hervorhebung (Cross-ZSF-Konsistenz).
\newcommand{\ZSFhl}[1]{\hl{#1}}
