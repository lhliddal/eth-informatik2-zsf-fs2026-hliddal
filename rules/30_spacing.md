---
description: "Spacing-Register (ZSFspace*), Gap-Makros (ZSFgap*), Math-Makros (C, R, F, laplace, …) — keine hardcodierten pt-Werte"
globs:
  - "chapters/**/*.tex"
  - "styles/30_layout_spacing.tex"
  - "styles/70_document_settings.tex"
alwaysApply: false
decisionOwner: ai
