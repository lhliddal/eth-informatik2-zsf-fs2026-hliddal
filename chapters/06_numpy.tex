...
% -----------------------------
\subsection{Array erzeugen}
\label{sec:06-array-erzeugen}
\begin{codebox}
...
\subsection{Array-Informationen}
\label{sec:06-array-informationen}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Indexing, Slicing, Maskierung}
\label{sec:06-indexing-slicing-maskierung}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Broadcasting und Shapes}
\label{sec:06-broadcasting-und-shapes}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Stacking und Splitting}
\label{sec:06-stacking-und-splitting}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Aggregate und Statistik}
\label{sec:06-aggregate-und-statistik}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
