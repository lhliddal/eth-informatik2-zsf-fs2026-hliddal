...
/**
 * ZSF Informatik II — Rules → Adapter compiler.
 *
 ...
 *
 * Entwurf orientiert an Webseiten/website-system-template/tools/sync-agent-rules.mjs,
 * angepasst an LaTeX-Projektkonventionen (rules/*.md als Quelle, Hash-Stempel, multi-Adapter).
 */
...
const PROJECT_SLUG = 'zsf-informatik2';
const PROJECT_TITLE = 'ZSF Informatik II';
