...
% -----------------------------
\subsection{Array erzeugen / Konstruktoren}\label{sec:06-array-erzeugen}
\begin{codebox}
...
\subsection{Broadcasting \& Form ändern}\label{sec:06-broadcasting-und-shapes}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Stacking \& Splitting (Zusammenfügen / Aufteilen)}\label{sec:06-stacking-und-splitting}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsection{Elementweise Mathematik}\label{sec:06-mathematik}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
