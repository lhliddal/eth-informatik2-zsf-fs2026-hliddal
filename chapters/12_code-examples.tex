% ============================================================
% ERGÄNZENDER TEIL — CODE-BEISPIELE
% Eine Stufe unter dem DP-Quiz (ch13): ergänzendes Referenzmaterial,
% aber NICHT frei löschbar — andere Kapitel verweisen hierher:
%   - ch03 -> \ZSFref{sec:12-dp-memoization}
%   - ch09 -> \ZSFref{sec:12-linked-lists}
% Vor einer Entfernung diese \ZSFref-Stellen anpassen, sonst dangling refs.
% Im Kapitelbalken als "ergänzender Teil" markiert (ZSFTitleTag).
% ============================================================
\section{Code-Beispiele\ZSFTitleTag{ergänzender Teil}}\label{sec:12-code-beispiele}

\subsection{Sortieralgorithmen}\label{sec:12-sortieralgorithmen}
...
\subsection{DP \& Memoization}\label{sec:12-dp-memoization}



%=====================================================================================================================
\subsubsection{Grid-DP: Bester Pfad (Max-Summe)}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
...
\subsubsection{Golomb-Zahlen (rekursiv, ohne Memo)}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
def golomb(n):
    """
...
\subsubsection{Springer-Matrix: Rekursion + DP}
\begin{codebox}[mit Recursion]
\begin{lstlisting}[style=CodeExpert]
...
\end{lstlisting}
\end{codebox}
\begin{codebox}[mit Dynamic Programming]
\begin{lstlisting}[style=CodeExpert]
def dp_best_way(a):
  n, m = len(a), len(a[0])
...
\subsection{ML: GridSearchCV \& Cross-Validation}\label{sec:12-ml-cross-validation}
...
\subsection{Linked Lists}\label{sec:12-linked-lists}
...
\subsection{String umkehren}\label{sec:12-string-umkehren}
