...
\begin{factlist}
\item Verwendet die \ZSFkeyword{sigmoid}-Funktion zur Klassenvorhersage:
  \[
...
\item Gut interpretierbar, aber anfällig für \ZSFkeyword{Overfitting}.
...
\item Erhöhtes Risiko von \ZSFkeyword{Overfitting}.
