...
\begin{statementbox}[Achtung]
Wenn Operatoren wie \verb|+| für Klassen überschrieben werden, sollte das Ergebnis wieder eine Instanz dieser Klasse sein. Sonst handelt es sich um einen undefinierten Datentyp, auf den keine Methoden wie \verb|__str__| angewendet werden können.
\end{statementbox}
\begin{codebox}
\begin{lstlisting}[style=CodeExpert]
class CustomString:
