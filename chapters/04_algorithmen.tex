...
\subsection{Übersicht: Sortier-Laufzeiten}\label{sec:04-uebersicht-sortier-laufzeiten}
\begin{tablebox}
\renewcommand{\arraystretch}{1.25}
\begin{ZSFtable}[\ZSFfontTableDense]{Q{1.25} Y{1} Y{1}}
\toprule
...
\subsection{Binary Insertion Sort}\label{sec:04-binary-sort}
\begin{procedure}[Ablauf]
