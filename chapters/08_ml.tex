...
\subsection{Wichtige Parameter}
\label{sec:08-wichtige-parameter}
\begin{contentbox}
\begin{itemize}
...
\subsection{Nicht-numerische Daten: Kategorische Merkmale encodieren}
\label{sec:08-kategorische-daten}
\begin{contentbox}
...
\label{sec:08-dimensionsreduktion}
\begin{contentbox}
\textbf{Faustregeln}
...
\subsection{Was tun, wenn der \texttt{accuracy\_score} zu niedrig ist?}
\label{sec:08-accuracy-zu-niedrig}
