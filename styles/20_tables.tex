% Adaptiert aus ZSF_Physik_V3/styles/20_tables.tex
% Anpassungen: \chaptercolor → title, \chaptercolorlight → title!10!white
...
%   - ueberstehende Zeilen (Content sprengt Box-Breite),
...
% voll ausfuellt. L/C/R zaehlen als Faktor 1.
%
...
% ------------------------------------------------------------
\newcommand{\ZSFzebraBG}{title!10!white}
...
% \rowcolor am Zeilenanfang gesetzt wird, NICHT zuverlaessig ueber die
...
\newcommand{\ZSFheaderRowBG}{title}
...
%   - \ZSFfontTableDense   (\footnotesize — fuer lange/dichte Tabellen)
%
...
% Reine Tabelle ohne Zebra (selten; fuer einspaltige Zebraschaeden etc.)
