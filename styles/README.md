...
| `40_colors_structure.tex` | 18-Slot-Kapitelpalette, Text-Tokens, CodeExpert-Palette |
...
| `66_index.tex` | opt-in: Stichwortverzeichnis (`\ZSFindex`, `\ZSFindexsee`, automatische `\ZSFkeyword`-Einträge) |
...
- Das Stichwortverzeichnis bleibt deaktiviert, bis es bewusst in `preamble.tex` aktiviert und ein `\printindex`-Kapitel am Dokumentende eingebunden wird. Die Index-Makros haben im deaktivierten Zustand sichere No-op-Fallbacks; Details stehen in `66_index.tex`.
