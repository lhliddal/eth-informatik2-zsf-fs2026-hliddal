% Adaptiert aus zsf-physik1-fs2026/styles/20_tables.tex
% Header/Zebra folgen der Kapitel-Palette (\chaptercolor, use-time expandiert)
\providecommand{\ZSFfontTable}{\normalsize}
\providecommand{\ZSFfontTableDense}{\footnotesize}
...
% ------------------------------------------------------------
\newcommand{\ZSFzebraBG}{\chaptercolor!10!white}
...
%   \begin{ZSFtable}[<font>][<row-stretch>]{<colspec>}
%   \begin{ZSFtableFlat}[<font>][<row-stretch>]{<colspec>}
%   \begin{ZSFtablePlain}[<font>][<row-stretch>]{<colspec>}
%
...
% <row-stretch> ist OPTIONAL und kommt aus styles/30_layout_spacing.tex:
%   - \ZSFtableRowStretchDefault (Default)
%   - \ZSFtableRowStretchRoomy   (mehr Höhe für formellastige Tabellen)
%
...
\NewDocumentEnvironment{ZSFtable}{O{\ZSFfontTable} O{\ZSFtableRowStretchDefault} m}{%
  #1%
...
\NewDocumentEnvironment{ZSFtableFlat}{O{\ZSFfontTable} O{\ZSFtableRowStretchDefault} m}{%
  #1%
  \renewcommand{\arraystretch}{#2}%
  \ZSFzebraStart{1}%
  \tabularx{\linewidth}{#3}%
...
\NewDocumentEnvironment{ZSFtablePlain}{O{\ZSFfontTable} O{\ZSFtableRowStretchDefault} m}{%
  #1%
  \renewcommand{\arraystretch}{#2}%
  \ZSFzebraOff
  \tabularx{\linewidth}{#3}%
